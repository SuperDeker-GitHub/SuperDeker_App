...
switch ($method) {
  case 'GET':
		$sql = "select repciDcs.repciId, repciDcTuplas.idDC, repciDcTuplas.value1,repciDcTuplas.value2 from repciDcTuplas,repciDcs,repcis where repciDcs.repciid=repcis.repciid and repcis.status=1 and (repciDcTuplas.value1='FechaRecordatorio' ) and repciDCTuplas.idDC = repciDcs.id and repciDcTuplas.idDC in ";		
		...
		$subsql =$subsql." 	repciDcs.DcType = 'Recordatorio' and ";
		$subsql =$subsql." 	repciDcTuplas.value1='FechaRecordatorio' and ";
