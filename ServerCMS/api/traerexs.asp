...
' 	SqlComd = SqlComd & "isnull(cantanex,-1) as favor, (q_attached-isnull(cantanex,0)) as NRA, "
	...
	if BX="Tareas" then	
		...
		BXSql = BXSql &	"			repciDcs.status>=0 and repciDcs.status<=2 and  "
		BXSql = BXSql &	"			repciDcs.id=repciDcTuplas.idDC and "
		BXSql = BXSql &	"			repciDcTuplas.value1='EjecutorTarea' and "
		...
		BXSql = BXSql &	"			repciDcs.id=repciDcTuplas.idDC and "
		BXSql = BXSql &	"			repciDcTuplas.value1='FechaTarea' and "
	...
	if BX="Recordatorios" then	
		...
		BXSql = BXSql &	"		repciDcs.id=repciDcTuplas.idDC and "
		BXSql = BXSql &	"		repciDcs.DcType = 'Recordatorio' and "
		BXSql = BXSql &	"		repciDcTuplas.value1='FechaRecordatorio' and "
		BXSql = BXSql &	"		repciDcTuplas.value2<='"&d2&"' "
		BXSql = BXSql &	" INTERSECT "
	...
	if BX="Citas" then	
		...
		BXSql = BXSql &	"		repciDcs.fromUser='" & Rsusr & "' and "
		BXSql = BXSql &	"		repciDcs.id=repciDcTuplas.idDC and "
		BXSql = BXSql &	"		repciDcs.DcType = 'Cita' and "
		BXSql = BXSql &	"		repciDcTuplas.value1='FechaCita' and "
		BXSql = BXSql &	"		repciDcTuplas.value2<='"&d2&"' "
		BXSql = BXSql &	" INTERSECT "
		BXSql = BXSql &	" select repciDcs.repciid "
		BXSql = BXSql &	" 	from "
	...
	if BX="Vencimientos" then	
		...
		BXSql = BXSql &	"		repciDcs.fromUser='" & Rsusr & "' and "
		BXSql = BXSql &	"		repciDcs.id=repciDcTuplas.idDC and "
		BXSql = BXSql &	"		(repciDcTuplas.value1='FechaVencimiento' or repciDcTuplas.value1='FechaCompromiso' or repciDcTuplas.value1='FechaAviso') and "
		BXSql = BXSql &	"		repciDcTuplas.value2<='"&d2&"' )"
